...
public interface LambdaStreamExc {
   ...
   * @return the list representation of the integer stream
   */
   ...
   *
   * @param intStream an integer stream
   * @return an integer stream with odd numbers
   */
   ...
   * @return a function that would take a string and print it out with a prefix and suffix
   */
